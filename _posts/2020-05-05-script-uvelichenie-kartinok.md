...
.image-enlager-left-arrow:hover
{
	background: url('{%- link assets/posts/script-uvelichenie-kartinok/left-arrow.svg -%}') no-repeat left;
}

.image-enlager-right-arrow:hover
{
	background: url('{%- link assets/posts/script-uvelichenie-kartinok/right-arrow.svg -%}') no-repeat right;
}
